            ...
            <div class="row bob mal0 marr0 pab6 mab6">
                ...
                <div style="">
                    <div class="stream-body">
                        ...
                        {if !($oStreamEvent->getEventType() == 'add_comment' && !is_null($oTarget->getGuestLogin()))}
                        ...
                        {elseif $oStreamEvent->getEventType() == 'add_comment'}
                            {if !is_null($oTarget->getGuestLogin())}
                                {$aLang.plugin.gc.new_comment} {$oTarget->getGuestLogin()} {$aLang.plugin.gc.to_publication}
                            {else}
