...
Пользователь {if !is_null($oComment->getGuestLogin())}{$oComment->getGuestLogin()}{else}<a href="{$oUserComment->getProfileUrl()}">{$oUserComment->getDisplayName()}</a>{/if} ответил на ваш комментарий в топике
