...
The user {if !is_null($oComment->getGuestLogin())}{$oComment->getGuestLogin()}{else}<a href="{$oUserComment->getProfileUrl()}">{$oUserComment->getDisplayName()}</a>{/if} replied your comment in the topic
